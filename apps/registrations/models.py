...
class Registration(BaseModel):
    ...
    tr_name = models.CharField(_("TR Name"), max_length=70)
    tr_phone = models.CharField(_("TR Phone"), max_length=15)
    tr_email = models.EmailField(_("TR Email"), max_length=254)
    tr_name_2 = models.CharField(_("TR Name"), max_length=70, blank=True, null=True)
    ...
    mr_name = models.CharField(_("MR Name"), max_length=70)
    mr_phone = models.CharField(_("MR Phone"), max_length=15)
    mr_email = models.EmailField(_("MR Email"), max_length=254)
    mr_name_2 = models.CharField(_("MR Name"), max_length=70, blank=True, null=True)
    ...
    fr_name = models.CharField(_("FR Name"), max_length=70)
    fr_phone = models.CharField(_("FR Phone"), max_length=15)
    fr_email = models.EmailField(_("FR Email"), max_length=254)
    fr_name_2 = models.CharField(_("FR Name"), max_length=70, blank=True, null=True)
    ...
    lr_name = models.CharField(_("LR Name"), max_length=70, blank=True, null=True)

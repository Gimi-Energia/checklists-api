...
def generate_pdf(instance):
    ...
    main_details = [
        ...
        f"Tensão Secundária: {checklist.secondary_voltage}",
        ...
        f"Definiu o fabricante do transformador e possui o projeto: {'Sim' if checklist.manufacturer_project else 'Não'}",

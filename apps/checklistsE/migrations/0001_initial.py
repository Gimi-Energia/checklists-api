# Generated by Django 4.2.4 on 2024-05-02 18:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concessionaire', models.CharField(blank=True, choices=[('ENEL', 'ENEL')], default='CEEE', max_length=20, null=True)),
                ...
                ('transformer_power', models.PositiveIntegerField(verbose_name='Transformer Power')),
                ...
                ('tranformer_connection', models.CharField(choices=[('Cables (Not Coupled)', 'Cables (Not Coupled)'), ('Coupled Transformer', 'Coupled Transformer'), ('Flanged Transformer', 'Flanged Transformer')], max_length=20, verbose_name='Transformer Connection')),
